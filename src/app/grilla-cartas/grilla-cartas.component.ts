...
@Component({
  selector: 'app-grilla-cartas',
  templateUrl: './grilla-cartas.component.html',
  styleUrls: ['./grilla-cartas.component.scss']
})
export class GrillaCartasComponent {
  nombreArticulo = '';
  precioArticulo = 0;
  tipoEnvioArticulo = '';
  imagenURLarticulo = '';
  ...
  seleccionarProducto(item: any) {
    ...
    this.amazonURLarticulo = item.amazonURL;
    this.idArticulo = item.id;
    ...
    console.log("amazonURLarticulo: " + this.amazonURLarticulo);
